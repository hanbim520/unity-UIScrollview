/**
 * ClassName: UIParticleSystemRender.cs
 * 
 * @author NavyZhang
...
namespace UnityEngine.UI
{
    ...
    public class UIParticleSystemRender : MaskableGraphic
    {
        ...
        protected bool Initialize()
        {
            ...
            if (_particleSystem == null)
            {
                ...
                //    _particleSystem.main.scalingMode = ParticleSystemScalingMode.Local;//change on unity editor
            ...
            {
                Material material = new Material(Shader.Find("Custom/ParticalHideShader"));
                if (Application.isPlaying)
                {
